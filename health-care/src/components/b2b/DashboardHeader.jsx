    ...
    <div className="bg-[var(--color-background-primary)] border-b-[0.5px] border-[var(--color-border-tertiary)] px-6 py-4">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <button className="px-4 py-2 border-[0.5px] border-[var(--color-border-secondary)] rounded-lg text-xs hover:bg-[var(--color-background-secondary)]">
            View Catalog
          </button>
          <button className="px-4 py-2 bg-brand-navy text-white rounded-lg text-xs font-medium">
            New Order
          </button>
        </div>
      </div>

                ...
                <div>
                  <label className="block text-sm text-[var(--color-text-secondary)] mb-1 flex items-center gap-1.5">
                    ...
                    {skuAutoGenerated && modalMode === 'create' && (
                      <span className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded text-xs font-semibold bg-[var(--color-status-success-tint)] text-brand-teal border border-success-tint-strong">

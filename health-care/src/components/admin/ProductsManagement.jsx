...
export default function ProductsManagement({ openCreateRef }) {
  ...
  /**
   * Auto-generate SKU when both category and brand are selected (create mode only).
   * Format: MC-{CAT}-{BRAND}-{SEQUENCE}  e.g. MC-DX-SIE-0042
   */
  const generateSku = useCallback(async (categoryId, brandId) => {
    if (!categoryId || !brandId || modalMode === 'edit') return;
    // Debounce: cancel any pending call
                      ...
                      onBlur={() => {
                        ...
                        setTimeout(() => {
                          ...
                          if (match) {
                            ...
                            if (createForm.category) generateSku(createForm.category, match._id);
                          }
                          setShowBrandDropdown(false);
                        }, 200);
                      }}
                          ...
                          .map(manufacturer => (
                            <div
                              ...
                              onClick={() => {
                                ...
                                setShowBrandDropdown(false);
                                if (createForm.category) generateSku(createForm.category, manufacturer._id);
                              }}
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={e => {
                      ...
                      if (newCat && createForm.brand) generateSku(newCat, createForm.brand);
                    }}

    ...
    <div className="bg-gradient-to-r from-white via-blue-50 to-cyan-50 border-b-[0.5px] border-blue-100 px-3 sm:px-4 md:px-6 py-3 sm:py-4 shadow-sm">
      <div className="flex items-center justify-between gap-2">
        <div className="flex-1 min-w-0">
          <h1 className="text-base sm:text-lg font-semibold mb-0.5 sm:mb-1 font-[family-name:var(--font-lora)] bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent truncate">
            {title}
          </h1>
          <div className="text-xs sm:text-xs text-[var(--color-text-secondary)] hidden sm:block">
            {currentDate}
          </div>
        </div>
        ...
        <div className="flex items-center gap-1.5 sm:gap-2 md:gap-3">
          ...
          <div className="relative hidden md:block">
            <input
              ...
              className="w-[180px] lg:w-[240px] pl-9 pr-3 py-[8px] bg-[var(--color-background-tertiary)] rounded-lg text-xs font-[family-name:var(--font-plus-jakarta)] focus:outline-none focus:bg-white focus:border-[0.5px] focus:border-[var(--color-border-secondary)]"
            />
            <svg
          ...
          <button aria-label="Profile" className="hidden sm:flex items-center gap-2 p-2 hover:bg-[var(--color-background-tertiary)] rounded-lg min-w-[44px] min-h-[44px]">
            <div className="w-8 h-8 bg-gradient-to-br from-brand-teal to-cyan-600 rounded-full flex items-center justify-center text-white font-semibold text-xs shadow-lg">
              SA
            </div>
          </button>
          ...
          <button
            className="px-3 sm:px-4 py-2 sm:py-[8px] bg-gradient-to-r from-blue-600 to-cyan-600 text-white rounded-lg text-xs sm:text-xs font-semibold font-[family-name:var(--font-plus-jakarta)] hover:shadow-lg hover:shadow-blue-500/50 transition-all transform hover:scale-105 min-h-[44px] whitespace-nowrap"

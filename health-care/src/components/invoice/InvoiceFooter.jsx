      ...
      <div className="bg-brand-navy px-6 py-4 text-white">
        <div className="mx-auto max-w-6xl">
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex flex-col gap-1.5 text-[11px] text-gray-300 sm:flex-row sm:gap-4">
          ...
          <div className="mt-3 border-t border-gray-600 pt-2 text-center text-[11px] text-gray-400">
            <p>

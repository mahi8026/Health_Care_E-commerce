      ...
      {wishlistCount === 0 ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
          {wishlist.map((product) => {
            ...
            const imageAlt = typeof primaryImage === 'object' ? primaryImage.alt : product.name;
                ...
                >
                  {imageUrl ? (
                    <>
                      ...
                      />
                      <div className="hidden absolute inset-0 items-center justify-center text-[50px] text-[#9CA3AF] bg-[#F3F4F6]">
                        🏥
                      </div>
                    </>
                  ) : (
                    ...
                    <div className="flex items-center gap-1 mb-2">
                      <div className="flex gap-[1px]">
                        {[...Array(5)].map((_, i) => (
                          <div 
                            key={i} 
                            className={`w-[10px] h-[10px] ${i < Math.round(product.rating.average) ? 'bg-[#F59E0B]' : 'bg-[var(--color-border-secondary)]'}`} 

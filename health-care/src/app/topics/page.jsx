    ...
    <div className="min-h-screen bg-background-secondary">
      ...
      <nav aria-label="Breadcrumb" className="bg-white border-b border-border-primary">
        <div className="container mx-auto max-w-6xl px-4 py-2.5 flex items-center gap-1.5 text-xs text-tertiary">
          ...
          <span>/</span>
          <span className="text-slate-900 font-medium">Topics</span>
        </div>
      </nav>
      ...
      <div className="container mx-auto max-w-6xl px-4 py-10">
        <div className="mb-6 flex items-center justify-between">
          <div>
            <h2 className="text-lg font-bold text-brand-navy">Browse All Topics</h2>
            ...
            return (
              ...
              >
                ...
                <div className="flex items-start justify-between mb-3">
                  ...
                  <div className={`flex items-center gap-1 rounded-full px-2.5 py-1 text-[11px] font-semibold ${accent.badge}`}>
                    {cluster.landingSlugs.length + cluster.guideSlugs.length} resources
                  </div>
                </div>

                {/* Title & description */}
                <h2 className="text-sm font-bold text-brand-navy mb-1.5 leading-snug group-hover:text-brand-teal transition-colors">
                  {cluster.title}
                </h2>
                ...
                <div className="mt-4 pt-3 border-t border-black/5 flex items-center justify-between">
                  ...
                  <span className="text-brand-teal font-semibold text-xs flex items-center gap-0.5 group-hover:gap-1.5 transition-all">
                    Explore
          ...
          {[
            {
              ...
              color: 'from-brand-navy to-brand-navy-deep',
            },
            {
              href: '/guides',
              icon: '📖',
            ...
            },
            {
              ...
              color: 'from-brand-navy-deep to-brand-navy',
            },
        ...
        {/* ── Quick links ─────────────────────────────────────────────── */}
        <section className="mt-8 rounded-2xl bg-white border border-border-primary p-6">
          <h2 className="text-sm font-bold text-brand-navy mb-3">Quick Links</h2>

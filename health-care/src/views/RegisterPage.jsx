...
export default function RegisterPage({ onSwitchToLogin, onSuccess }) {
  ...
  const getPasswordStrength = (pwd) => {
    ...
    return { label: 'Strong', color: 'bg-brand-teal', width: 'w-full' };
  };
                  ...
                  <label key={type.value} className="cursor-pointer">
                    ...
                    <div className={`p-4 rounded-xl border-2 text-center transition-all duration-200 ${
                      ...
                      <div className={`text-sm font-semibold ${
                        formData.accountType === type.value
                          ? type.value === 'B2B' ? 'text-brand-teal' : 'text-brand-navy'
                          : 'text-[var(--color-text-primary)]'
                      }`}>{type.title}</div>
                      <div className="text-xs text-[var(--color-text-secondary)] mt-0.5">{type.sub}</div>
                    </div>
                  </label>
                ))}
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    autoComplete="name"
                    className={`w-full pl-10 pr-4 py-3 bg-white border rounded-xl text-base text-[var(--color-text-primary)] placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-brand-teal/30 focus:border-brand-teal transition-all ${errors.name ? 'border-[var(--color-status-danger)]' : 'border-[var(--color-border-primary)]'}`}
                  />
                </div>
                {errors.name && <p className="mt-1 text-xs text-[var(--color-status-danger)]" role="alert" aria-live="polite">{errors.name}</p>}
              </div>

              <div>
                <label htmlFor="register-email" className="block text-sm font-medium text-[var(--color-text-primary)] mb-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    autoComplete="email"
                    className={`w-full pl-10 pr-4 py-3 bg-white border rounded-xl text-base text-[var(--color-text-primary)] placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-brand-teal/30 focus:border-brand-teal transition-all ${errors.email ? 'border-[var(--color-status-danger)]' : 'border-[var(--color-border-primary)]'}`}
                  />
                </div>
                {errors.email && <p className="mt-1 text-xs text-[var(--color-status-danger)]" role="alert" aria-live="polite">{errors.email}</p>}
              </div>
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-10 pr-10 py-3 bg-white border rounded-xl text-base text-[var(--color-text-primary)] placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-brand-teal/30 focus:border-brand-teal transition-all ${errors.password ? 'border-[var(--color-status-danger)]' : 'border-[var(--color-border-primary)]'}`}
                  />
                  <button
                    type="button"
                    ...
                    className="absolute inset-y-0 right-0 pr-3 flex items-center text-[var(--color-text-secondary)] hover:text-[var(--color-text-secondary)]">
                    {showPassword ? (
                ...
                {errors.password && <p className="mt-1 text-xs text-[var(--color-status-danger)]" role="alert" aria-live="polite">{errors.password}</p>}
              </div>

              <div>
                <label htmlFor="register-confirm-password" className="block text-sm font-medium text-[var(--color-text-primary)] mb-1.5">
                  Confirm Password <span className="text-[var(--color-status-danger)]">*</span>
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                    <svg className="w-4 h-4 text-[var(--color-text-secondary)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <input
                    ...
                    required
                    autoComplete="new-password"
                    className={`w-full pl-10 pr-10 py-3 bg-white border rounded-xl text-base text-[var(--color-text-primary)] placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-brand-teal/30 focus:border-brand-teal transition-all ${errors.confirmPassword ? 'border-[var(--color-status-danger)]' : 'border-[var(--color-border-primary)]'}`}
                  />
                  <button
                    type="button"
                ...
                {errors.confirmPassword && <p className="mt-1 text-xs text-[var(--color-status-danger)]" role="alert" aria-live="polite">{errors.confirmPassword}</p>}
              </div>
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    autoComplete="tel"
                    className={`w-full pl-10 pr-4 py-3 bg-white border rounded-xl text-base text-[var(--color-text-primary)] placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-brand-teal/30 focus:border-brand-teal transition-all ${errors.phone ? 'border-[var(--color-status-danger)]' : 'border-[var(--color-border-primary)]'}`}
                  />
                </div>
                {errors.phone && <p className="mt-1 text-xs text-[var(--color-status-danger)]" role="alert" aria-live="polite">{errors.phone}</p>}
              </div>

              {formData.accountType === 'B2B' && (
                <div>
                  <label htmlFor="register-company" className="block text-sm font-medium text-[var(--color-text-primary)] mb-1.5">
                    Company Name <span className="text-[var(--color-status-danger)]">*</span>
                  </label>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                      <svg className="w-4 h-4 text-[var(--color-text-secondary)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    className={`w-full pl-10 pr-4 py-3 bg-white border rounded-xl text-base text-[var(--color-text-primary)] placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-brand-teal/30 focus:border-brand-teal transition-all ${errors.company ? 'border-[var(--color-status-danger)]' : 'border-[var(--color-border-primary)]'}`}
                  />
                  </div>
                  {errors.company && <p className="mt-1 text-xs text-[var(--color-status-danger)]" role="alert" aria-live="polite">{errors.company}</p>}
                </div>
              )}
            </div>

  ...
  const handleResetEmail = async () => {
    ...
    try {
      ...
      if (recaptchaSiteKey) {
        ...
        // null is acceptable — don't block password reset email
      }
            ...
            <div>
              ...
              <div className="bg-[var(--color-status-warning-tint)] border border-[var(--color-status-warning-tint)] rounded-lg p-3 mb-4">
                <p className="text-xs text-warning-ink">
                  ...
                  <a href="mailto:mediportbdofficial@gmail.com" className="font-semibold underline">mediportbdofficial@gmail.com</a>.
                </p>
              </div>
              <button
                type="button"
